 ...
 * @LastEditTime: 2025-06-03 15:22:03
 * @LastEditors: Mr.Xiong
 * @Description:
 * @FilePath: /Data-Structure/LIST/LinkList/linklist.c
 * 世上无难事,只怕有心人
...
/* Free list. */
void list_free(struct linklist *l)
{
    free(l);
    l = NULL;
}
...
void listnode_delete(struct linklist *list, void *val)
{
    struct listnode *node;
...
void list_delete_all_node(struct linklist *list)
{
    struct listnode *node;
...
void list_delete(struct linklist *list)
{
...
void list_pointer_init(list_pointer_t *p_list)
{
    _LHEAD(p_list) = NULL;
...
void list_pointer_insert_head(list_pointer_t *p_list, list_pointer_node_t *p_node)
{
...
void list_pointer_insert_tail(list_pointer_t *p_list, list_pointer_node_t *p_node)
{
    p_node->p_next = NULL;
...
void list_pointer_insert_after(list_pointer_t *p_list, list_pointer_node_t *p_node1, list_pointer_node_t *p_node2)
{
...
void list_pointer_insert_before(list_pointer_t *p_list, list_pointer_node_t *p_node1, list_pointer_node_t *p_node2)
{
...
void list_pointer_delete(list_pointer_t *p_list, list_pointer_node_t *p_node)
{
...
int list_pointer_empty(list_pointer_t *p_list)
{
